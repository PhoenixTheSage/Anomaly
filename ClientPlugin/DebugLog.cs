...
{
    public const string FileName = "Anomaly.debug.log";
    ...
    public static void Open()
    {
        lock (Gate)
        {
            ...
            try
            {
                ...
                _writer.WriteLine("Anomaly debug log");
                _writer.WriteLine("opened {0:o}", DateTime.Now);
                _writer.WriteLine("folder {0}", dir);
                _writer.WriteLine();
                try
                {
                    MyLog.Default.WriteLine("Anomaly debug log: " + FilePath);
                }
                catch
                {
                    // ignored
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    MyLog.Default.WriteLine("Anomaly debug log failed to open: " + e.Message);
                }
                catch
                {
                    // ignored
